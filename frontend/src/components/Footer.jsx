  ...
  return (
    <footer className="relative z-10 border-t border-white/5 bg-[#030304] px-8 md:px-16 py-20 snap-start font-outfit">
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 w-full">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2.5 text-xs text-white/55 font-light">
            <a href="#vision" className="hover:text-[#e4c37a] transition-colors">Core Concept</a>
            <a href="#workflow" className="hover:text-[#e4c37a] transition-colors">CFO Dashboard</a>
            <a href="#features" className="hover:text-[#e4c37a] transition-colors">Protocol Specs</a>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2.5 text-xs text-white/55 font-light">
            <a href="#" className="hover:text-[#e4c37a] transition-colors">Documentation</a>
            <a href="#" className="hover:text-[#e4c37a] transition-colors">Developer Portal</a>
            <a href="#" className="hover:text-[#e4c37a] transition-colors">Smart Contracts</a>
            <a href="#" className="hover:text-[#e4c37a] transition-colors">Morph L2 Explorer</a>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2.5 text-xs text-white/55 font-light">
            <a href="#" className="hover:text-[#e4c37a] transition-colors">Security Audit</a>
            <a href="#" className="hover:text-[#e4c37a] transition-colors">Risk Parameters</a>
            <a href="#" className="hover:text-[#e4c37a] transition-colors">Terms of Carriage</a>
          </div>
        </div>
      ...
      <div className="max-w-[1400px] mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col items-center justify-between gap-4 md:flex-row text-[10px] text-white/30 tracking-widest uppercase">
        <p>&copy; {new Date().getFullYear()} Fehuvia Corporation. All rights reserved on Morph Testnet.</p>
        <div className="flex space-x-6">
          <a href="#" className="hover:text-[#e4c37a] transition-colors">Privacy Charter</a>
          <a href="#" className="hover:text-[#e4c37a] transition-colors">Risk Warning</a>
        </div>
      </div>
