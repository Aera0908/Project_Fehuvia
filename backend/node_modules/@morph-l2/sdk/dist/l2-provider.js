...
const connectGasPriceOracle = (provider) => {
    console_1.Console.log('connectGasPriceOracle MORPH_L2_GasPriceOracle', process.env.MORPH_L2_GasPriceOracle);
    return new ethers_1.Contract(process.env.MORPH_L2_GasPriceOracle || predeploys_1.predeploys.GasPriceOracle, (0, contract_defs_1.getContractInterface)('GasPriceOracle'), (0, utils_1.toProvider)(provider));
};
