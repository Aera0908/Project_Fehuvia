...
const connectGasPriceOracle = (provider: ProviderLike): Contract => {
  Console.log('connectGasPriceOracle MORPH_L2_GasPriceOracle', process.env.MORPH_L2_GasPriceOracle);
  return new Contract(
    process.env.MORPH_L2_GasPriceOracle || predeploys.GasPriceOracle,
    getContractInterface('GasPriceOracle'),
    toProvider(provider)
  )
}
...
export const asL2Provider = <TProvider extends Provider>(
  ...
  // Modify the block formatter to return the state root. Not strictly related to Morph, just a
