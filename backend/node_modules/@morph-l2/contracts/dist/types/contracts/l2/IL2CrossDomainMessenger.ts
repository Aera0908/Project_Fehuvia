...
export interface IL2CrossDomainMessengerInterface extends utils.Interface {
  ...
  events: {
    ...
    "UpdateMaxFailedExecutionTimes(uint256,uint256)": EventFragment;
  };
  ...
  getEvent(
    nameOrSignatureOrTopic: "UpdateMaxFailedExecutionTimes"
  ): EventFragment;
}
...
export interface UpdateMaxFailedExecutionTimesEventObject {
  oldMaxFailedExecutionTimes: BigNumber;
  newMaxFailedExecutionTimes: BigNumber;
}
export type UpdateMaxFailedExecutionTimesEvent = TypedEvent<
  [BigNumber, BigNumber],
  UpdateMaxFailedExecutionTimesEventObject
>;

export type UpdateMaxFailedExecutionTimesEventFilter =
  TypedEventFilter<UpdateMaxFailedExecutionTimesEvent>;
...
export interface IL2CrossDomainMessenger extends BaseContract {
  ...
  filters: {
    ...
    "UpdateMaxFailedExecutionTimes(uint256,uint256)"(
      oldMaxFailedExecutionTimes?: null,
      newMaxFailedExecutionTimes?: null
    ): UpdateMaxFailedExecutionTimesEventFilter;
