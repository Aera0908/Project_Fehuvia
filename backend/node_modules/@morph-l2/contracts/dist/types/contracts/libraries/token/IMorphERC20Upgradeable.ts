...
export interface IMorphERC20UpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IMorphERC20Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMorphERC20UpgradeableInterface;
