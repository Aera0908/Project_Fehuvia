...
export interface CrossDomainMessengerInterface extends utils.Interface {
  functions: {
    ...
    "updateFeeVault(address)": FunctionFragment;
  ...
  events: {
    ...
    "UpdateFeeVault(address,address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "UpdateFeeVault"): EventFragment;
}
...
export interface UpdateFeeVaultEventObject {
  _oldFeeVault: string;
  _newFeeVault: string;
}
export type UpdateFeeVaultEvent = TypedEvent<
  [string, string],
  UpdateFeeVaultEventObject
>;

export type UpdateFeeVaultEventFilter = TypedEventFilter<UpdateFeeVaultEvent>;
...
export interface CrossDomainMessenger extends BaseContract {
  ...
  functions: {
    ...
    updateFeeVault(
      _newFeeVault: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "UpdateFeeVault(address,address)"(
      _oldFeeVault?: PromiseOrValue<string> | null,
      _newFeeVault?: PromiseOrValue<string> | null
    ): UpdateFeeVaultEventFilter;
    UpdateFeeVault(
      _oldFeeVault?: PromiseOrValue<string> | null,
      _newFeeVault?: PromiseOrValue<string> | null
    ): UpdateFeeVaultEventFilter;
