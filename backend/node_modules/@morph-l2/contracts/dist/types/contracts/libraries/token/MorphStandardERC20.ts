...
export interface MorphStandardERC20Interface extends utils.Interface {
  functions: {
...
export interface MorphStandardERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MorphStandardERC20Interface;
