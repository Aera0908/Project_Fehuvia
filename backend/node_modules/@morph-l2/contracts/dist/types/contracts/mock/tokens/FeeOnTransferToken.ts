...
export interface FeeOnTransferTokenInterface extends utils.Interface {
  functions: {
...
export interface FeeOnTransferToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeOnTransferTokenInterface;
