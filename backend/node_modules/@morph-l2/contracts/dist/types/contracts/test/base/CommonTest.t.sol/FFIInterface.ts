...
export declare namespace Types {
  export type StakerInfoStruct = {
    addr: PromiseOrValue<string>;
    tmKey: PromiseOrValue<BytesLike>;
    blsKey: PromiseOrValue<BytesLike>;
  };

  export type StakerInfoStructOutput = [string, string, string] & {
    addr: string;
    tmKey: string;
    blsKey: string;
  };
...
export interface FFIInterfaceInterface extends utils.Interface {
  functions: {
    ...
    "generateStakerInfo(address)": FunctionFragment;
    "getProveWithdrawalCheckProof(uint64)": FunctionFragment;
    "getProveWithdrawalTransactionInputs(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "generateStakerInfo",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getProveWithdrawalCheckProof",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "getProveWithdrawalTransactionInputs",
...
export interface FFIInterface extends BaseContract {
  ...
  functions: {
    ...
    getProveWithdrawalTransactionInputs(
      withdrawalHash: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    generateStakerInfo(
      _staker: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<Types.StakerInfoStructOutput>;
