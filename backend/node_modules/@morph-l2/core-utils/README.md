...
`@morph-l2/core-utils` contains the Morph Virtual Machine core utilities.
...
```typescript
import { TxGasLimit } from '@morph-l2/core-utils'
import { JsonRpcProvider } from 'ethers'

const L2Provider = new JsonRpcProvider('http://127.0.0.1:9545')
